...
- I want everything production quality before we push it to Github, or I will get fired
- Main programming language is Python, package en env management is with Poetry